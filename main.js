...
class AppComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      styles: ["@charset \"UTF-8\";\n.demo app-header, .demo app-table-sunheader-file, .demo app-editor-header, .demo .subheader.component {\n  position: static;\n}\n.demo app-request app-table-filter, .demo app-contractor app-table-filter, .demo app-client app-table-filter {\n  position: static;\n}\n\napp-header, app-table-sunheader-file, app-editor-header, .subheader.component {\n  position: sticky;\n  top: 0;\n  left: 0;\n  right: 0;\n  z-index: 1000;\n}\n\napp-table-sunheader-file, app-editor-header, .subheader.component {\n  top: 56px;\n}\napp-table-sunheader-file .subheader, app-editor-header .subheader, .subheader.component .subheader {\n  border-top: 1px solid var(--header_menu, #4B66AD);\n}\n\napp-request-details .subheader.component {\n  border-top: 1px solid #4B66AD;\n}\n\napp-request app-table-filter, app-contractor app-table-filter, app-client app-table-filter {\n  position: sticky;\n  top: 114.5px;\n  left: 0;\n  right: 0;\n  z-index: 100;\n}\napp-request app-table-filter .filter, app-contractor app-table-filter .filter, app-client app-table-filter .filter {\n  background-color: var(--background, #f7f9fc);\n  border-bottom: 1px solid var(--line, #E0E5EB);\n}\n\napp-settings {\n  min-height: 100vh;\n}\n\ntable .column {\n  box-sizing: border-box;\n  flex-grow: 1;\n}\n\nng-scrollbar.ng-scrollbar {\n  --scrollbar-size: 8px;\n  --scrollbar-thumb-color: #6200ee;\n  --scrollbar-track-color: #f1f1f1;\n  --scrollbar-border-radius: 4px;\n}\n\n.scrollbar-control {\n  background-color: red;\n}\n\ntable a.link {\n  color: var(--text, rgba(0, 0, 0, 0.87));\n}\n\n.table-form {\n  --mat-table-background-color:#83909E;\n}\n.table-form .table {\n  width: 100%;\n}\n\ntable th .td-block-line {\n  background-color: #83909E;\n}\ntable th .td-block-line .column {\n  position: relative;\n}\ntable th .td-block-line .resize-handle {\n  top: 0;\n  bottom: -1px;\n}\n\ntable .mdc-data-table__header-cell {\n  overflow: visible;\n}\n\n.table-list .td-block .column {\n  position: relative;\n}\n\n.table-list .resize-handle {\n  position: absolute;\n  right: -1.5px;\n  width: 3px;\n  top: -9px;\n  bottom: -7px;\n  background-color: inherit;\n  cursor: col-resize;\n  pointer-events: none;\n  z-index: 10;\n}\n.table-list .resize-handle_end {\n  cursor: col-resize;\n  position: absolute;\n  left: -2px;\n  width: 3px;\n  top: 0;\n  bottom: 0;\n  pointer-events: none;\n  z-index: 10;\n}\n\n.table-list.resize .resize-handle, .table-list.resize .resize-handle_end {\n  background-color: #DB563B;\n  pointer-events: all;\n}\n.table-list.resize .resize-handle_end::before, .table-list.resize .resize-handle::before {\n  content: \"\";\n  position: absolute;\n  left: -5px;\n  right: -5px;\n  top: 7px;\n  bottom: 7px;\n  background-color: #DB563B;\n  border-radius: 3px;\n}\n.table-list.resize table thead .column {\n  overflow: visible;\n}\n\nbutton {\n  cursor: pointer;\n}\n\n.mat-mdc-dialog-container form.edit-form {\n  margin: 20px;\n}\n\n.no-layout {\n  display: contents;\n}\n\n.loader {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  z-index: 10000;\n}\n\n.cdk-overlay-container mat-snack-bar-container.mdc-snackbar.centered-snackbar {\n  margin-top: 50vh;\n}\n\n.table-list thead .column {\n  height: 36px;\n}\n\n.table-list tbody .column {\n  overflow: hidden;\n}\n\n.table-list .td-block .column {\n  align-items: center;\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n}\n\n.table-list .mat-mdc-select {\n  background-color: inherit;\n  border: none;\n  font-weight: 400;\n  font-size: 13px;\n  line-height: 16px;\n  max-width: 150px;\n}\n.table-list .mat-mdc-select .mat-mdc-select-trigger {\n  padding: 0;\n}\n\nmat-form-field.mat-mdc-form-field {\n  width: 100%;\n  height: 40px;\n}\nmat-form-field.mat-mdc-form-field .mat-mdc-text-field-wrapper,\nmat-form-field.mat-mdc-form-field .mat-mdc-text-field-wrapper .mat-mdc-form-field-flex,\nmat-form-field.mat-mdc-form-field .mat-mdc-form-field-flex .mat-mdc-form-field-infix {\n  margin: 0;\n  padding: 0;\n  height: 100%;\n}\nmat-form-field.mat-mdc-form-field .mat-mdc-form-field-subscript-wrapper {\n  display: none;\n}\nmat-form-field.mat-mdc-form-field .mdc-notched-outline__leading,\nmat-form-field.mat-mdc-form-field .mdc-notched-outline__notch,\nmat-form-field.mat-mdc-form-field .mdc-notched-outline__trailing {\n  border: none !important; /* \u0423\u0431\u0438\u0440\u0430\u0435\u043C \u0440\u0430\u043C\u043A\u0438 */\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
      encapsulation: 2
    });
  }
}
...
/* harmony import */ var _angular_common_locales_ru__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common/locales/ru */ 7566);
...
/* harmony import */ var ngx_scrollbar__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ngx-scrollbar */ 4091);
...
/* harmony import */ var _loader_loader_interceptor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./loader/loader.interceptor */ 9080);
...
class AppModule {
  constructor() {
    (0,_angular_common__WEBPACK_IMPORTED_MODULE_8__.registerLocaleData)(_angular_common_locales_ru__WEBPACK_IMPORTED_MODULE_9__["default"]);
  }
  static {
  ...
  static {
    this.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineInjector"]({
      providers: [{
        ...
        useClass: _loader_loader_interceptor__WEBPACK_IMPORTED_MODULE_7__.LoadingInterceptor,
        multi: true
      }, {
        provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_11__.HTTP_INTERCEPTORS,
        ...
        provide: _angular_router__WEBPACK_IMPORTED_MODULE_12__.TitleStrategy,
        useClass: _page_title_service__WEBPACK_IMPORTED_MODULE_5__.PageTitleService
      }],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_13__.BrowserModule, _app_routing_module__WEBPACK_IMPORTED_MODULE_1__.AppRoutingModule, _auth_auth_module__WEBPACK_IMPORTED_MODULE_0__.AuthModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_11__.HttpClientModule, _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_14__.BrowserAnimationsModule, _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_15__.MatDatepickerModule, ngx_scrollbar__WEBPACK_IMPORTED_MODULE_16__.NgScrollbarModule]
    });
  }
}
(function () {
...
class LoadingInterceptor {
  ...
  static {
    this.ɵfac = function LoadingInterceptor_Factory(t) {
      return new (t || LoadingInterceptor)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_loader_service__WEBPACK_IMPORTED_MODULE_0__.LoaderService));
    };
  }
  static {
    this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
...
function EditorHeaderComponent_a_2_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "\u041E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u044B\u0435 \u043F\u043E\u043B\u044F: ");
...
function EditorHeaderComponent_a_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorHeaderComponent_a_2_Template_a_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7);
      const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresetView"](ctx_r6.goBack());
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, EditorHeaderComponent_a_2_div_2_Template, 4, 0, "div", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](3, EditorHeaderComponent_a_2_div_3_Template, 2, 1, "div", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
  }
  if (rf & 2) {
...
function EditorHeaderComponent_a_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorHeaderComponent_a_3_Template_a_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);
      const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresetView"](ctx_r9.goBack());
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, EditorHeaderComponent_a_3_div_2_Template, 4, 0, "div", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
  }
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", !ctx_r1.isEditMode);
  }
}
function EditorHeaderComponent_div_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" \u0417\u0430\u043F\u0440\u043E\u0441 \u2116", ctx_r2.request == null ? null : ctx_r2.request.id, " ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("", ctx_r2.request == null ? null : ctx_r2.request.rate_contractor_name, " ");
  }
}
function EditorHeaderComponent_div_7_span_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorHeaderComponent_div_7_span_1_Template_span_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15);
      const ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresetView"](ctx_r14.onSave());
    });
...
function EditorHeaderComponent_div_7_span_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorHeaderComponent_div_7_span_5_Template_span_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r17);
      const ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresetView"](ctx_r16.goCalc());
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "\u0440\u0430\u0441\u0447\u0438\u0442\u0430\u0442\u044C");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]()();
  }
}
function EditorHeaderComponent_div_7_span_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorHeaderComponent_div_7_span_6_Template_span_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r19);
      const ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresetView"](ctx_r18.onRemove());
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "span");
...
function EditorHeaderComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, EditorHeaderComponent_div_7_span_1_Template, 3, 0, "span", 14);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "span", 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorHeaderComponent_div_7_Template_span_click_2_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);
      const ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresetView"](ctx_r20.onSave());
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "\u0441\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]()();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](5, EditorHeaderComponent_div_7_span_5_Template, 3, 0, "span", 16);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](6, EditorHeaderComponent_div_7_span_6_Template, 3, 0, "span", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "span", 18);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorHeaderComponent_div_7_Template_span_click_7_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);
      const ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresetView"](ctx_r22.goBack());
    });
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r3.isSend);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r3.isEditMode && ctx_r3.isCalck);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r3.isEditMode);
  }
}
const _c0 = [[["", "btns", ""]]];
const _c1 = ["[btns]"];
class EditorHeaderComponent {
  constructor(location) {
    ...
    this.calc = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter();
    this.isCalck = false;
    this.content = false;
    this.request = {};
  ...
  static {
    this.ɵfac = function EditorHeaderComponent_Factory(t) {
      return new (t || EditorHeaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__.Location));
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function EditorHeaderComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, EditorHeaderComponent_a_2_Template, 4, 3, "a", 2);
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](3, EditorHeaderComponent_a_3_Template, 3, 2, "a", 3);
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](4, EditorHeaderComponent_div_4_Template, 4, 2, "div", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](5, "div", 5);
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵprojection"](6);
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](7, EditorHeaderComponent_div_7_Template, 10, 3, "div", 6);
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]()();
        }
        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
class PopupDialogComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: [".mat-dialog-container {\n  padding: 0;\n  background: #fff;\n  min-width: 500px;\n  line-height: 1.3em;\n  position: relative;\n}\n\n.mat-dialog-title {\n  font-size: 24px;\n  padding: 32px 32px;\n  margin: 0;\n  font-weight: 700;\n}\n\n.close {\n  position: absolute;\n  top: 15px;\n  right: 15px;\n  width: 20px;\n  height: 20px;\n  background: url(\"/assets/pic-close.svg\") no-repeat center center;\n  cursor: pointer;\n}\n\n.close:hover {\n  opacity: 0.6;\n}\n\n.mat-dialog-content {\n  margin: 0;\n  font-size: 15px;\n  padding: 32px;\n  background: #F7F9FC;\n  border-top: 1px solid #E0E5EB;\n  border-bottom: 1px solid #E0E5EB;\n}\n\n.mat-dialog-content > :first-child {\n  margin-top: 0;\n}\n\n.mat-dialog-content > :last-child {\n  margin-bottom: 0;\n}\n\n.mat-dialog-actions {\n  padding: 32px;\n  margin: 0;\n}\n\n.mat-dialog-actions .mat-button {\n  cursor: pointer;\n  font-size: 15px;\n  color: #FFFFFF;\n  background: #DB563B;\n  box-shadow: 0px 2px 8px rgba(44, 54, 64, 0.13);\n  border-radius: 6px;\n  padding: 13px 16px;\n  border: none;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
      encapsulation: 2
    });
  }
}
...
class RequestRateComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      styles: ["@charset \"UTF-8\";\n.w110 {\n  flex-grow: 0;\n  max-width: 110px;\n}\n\n.logo-box {\n  height: 80px;\n  background: #fff;\n  border: 1px solid #c3ccd6;\n  border-right: none;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);\n}\n\n.logo-box div {\n  background-image: url('logo-full.svg');\n  background-size: auto;\n  background-repeat: no-repeat;\n  width: 1280px;\n  height: 44px;\n  margin: 18px auto;\n}\n\n.form-block .form-item-layout + .form-item-layout {\n  margin-top: 40px;\n}\n\ndiv {\n  text-rendering: optimizeLegibility;\n}\n\n.edit-form {\n  width: 1280px;\n}\n\n.edit-form.title {\n  font-size: 26px;\n  line-height: 30px;\n  font-weight: bold;\n  color: #2C3640;\n  display: flex;\n  justify-content: space-between;\n}\n\n.time-add {\n  text-transform: none;\n  font-size: 12px;\n  line-height: 12px;\n  font-weight: normal;\n  color: #606A74;\n}\n\n.time-add span {\n  font-weight: bold;\n  color: #2C3640;\n  font-size: 14px;\n}\n\n.form-col .form-label {\n  text-transform: none;\n  font-size: 12px;\n  line-height: 12px;\n  font-weight: normal;\n  margin-bottom: 15px;\n}\n\n.details-total {\n  text-wrap: nowrap;\n}\n\n.details-total span {\n  font-size: 15px;\n  font-weight: normal;\n}\n\n.space {\n  margin: 0 7px;\n  color: #606A74;\n  font-size: 17px;\n}\n\n.details-total sup {\n  font-size: 10px;\n}\n\n.df {\n  display: flex;\n}\n\n.form-col {\n  flex-grow: 1;\n  border-right: 1px solid #C3CCD6;\n  margin: -40px 0 -40px 0;\n  width: 0;\n  max-width: 381px;\n  padding: 40px;\n  font-weight: bold;\n  color: #2C3640;\n}\n\n.form-col:first-child {\n  margin-left: -40px;\n}\n\n.form-col:last-child {\n  margin-right: -40px;\n  border-right: 0;\n}\n\n.form-block .form-col .form-block-sub-title + .form-item-layout {\n  margin-top: 25px;\n}\n\n.form-col textarea {\n  background: none;\n  height: 150px;\n  border: none;\n  padding: 0;\n  margin: 0;\n  width: 100%;\n  line-height: 30px;\n  resize: none;\n}\n\n.form-col .form-col-title {\n  color: #4B66AD;\n  font-weight: bold;\n  font-size: 20px;\n  line-height: 20px;\n  padding-bottom: 25px;\n}\n\ndiv.mat-calendar-body-selected, .mat-calendar-body-cell.selected .mat-calendar-body-cell-content {\n  background: #DB563B;\n  border-radius: 6px;\n}\n\n.mat-calendar-body-cell.disabled-date {\n  pointer-events: none; /* \u041E\u0442\u043A\u043B\u044E\u0447\u0430\u0435\u043C \u043A\u043B\u0438\u043A\u0438 */\n}\n\n.disabled-date .mat-calendar-body-cell-content {\n  color: #ccc; /* \u0421\u0435\u0440\u044B\u0439 \u0446\u0432\u0435\u0442 \u0442\u0435\u043A\u0441\u0442\u0430 */\n  text-decoration: line-through; /* \u041F\u0435\u0440\u0435\u0447\u0435\u0440\u043A\u0438\u0432\u0430\u0435\u043C \u0442\u0435\u043A\u0441\u0442 */\n}\n\n.form-row .form-row-title {\n  color: #2C3640;\n  font-weight: bold;\n  font-size: 20px;\n  line-height: 20px;\n  padding-bottom: 25px;\n}\n\n.form-row .color-blue {\n  color: #4B66AD;\n}\n\n.file-box {\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);\n  border-radius: 6px;\n  height: 15px;\n  padding: 10px 10px;\n  margin-right: 5px;\n  margin-bottom: 15px;\n  color: #DB563B;\n  text-wrap: nowrap;\n  cursor: pointer;\n  background: url('pic-btn-download.svg') no-repeat;\n  background-position: left;\n  padding-left: 35px;\n  background-position: 10px;\n}\n\n.file-box:hover {\n  opacity: 0.7;\n}\n\n.wrap {\n  flex-wrap: wrap;\n}\n\n.radio {\n  margin-left: 20px;\n  margin-bottom: 25px;\n}\n\n.comment {\n  color: #2C3640;\n}\n\n.rate-block-title {\n  display: flex;\n  align-items: baseline;\n  margin-bottom: 20px;\n}\n\n.rate_labels {\n  height: 45px;\n  margin-bottom: -40px;\n  display: flex;\n}\n\n.rate_label {\n  justify-content: center;\n  padding: 0 5px;\n  display: flex;\n  align-items: center;\n  height: 100%;\n  min-width: 130px;\n  border-right: 1px solid #C3CCD6;\n  border-top: 1px solid #C3CCD6;\n  font-weight: bold;\n  cursor: pointer;\n}\n\n.rate_label:first-child {\n  border-left: 1px solid #C3CCD6;\n}\n\n.active-rate {\n  background-color: white;\n  color: #2C3640;\n  font-weight: bold;\n  font-size: 17px;\n  line-height: 17px;\n}\n\n.rate_labels-btns {\n  border: none;\n  width: -moz-fit-content;\n  width: fit-content;\n  height: 80%;\n  margin: 5px 0 5px 5px;\n  border-radius: 6px;\n  color: white;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  padding: 5px 10px;\n  cursor: pointer;\n}\n\n.btn-add-rate {\n  background-color: #DB563B;\n}\n\n.btn-dup-rate {\n  background-color: #4B66AD;\n}\n\n.btn-del-rate {\n  background-color: black;\n}\n\n.icon-btn-plus {\n  background-image: url('pic-btn-plus.svg');\n  background-repeat: no-repeat;\n  width: 10px;\n  height: 10px;\n  margin-right: 5px;\n}\n\n.icon-btn-del {\n  background-image: url('pic-btn-del.svg');\n  background-size: contain;\n  background-repeat: no-repeat;\n  width: 15px;\n  height: 15px;\n  margin-right: 5px;\n}\n\n.kg {\n  display: flex;\n  align-items: center;\n  gap: 5px;\n}\n\n.mat-primary .mat-pseudo-checkbox-checked, .mat-primary .mat-pseudo-checkbox-indeterminate {\n  background: #DB563B;\n}\n\n.mat-primary .mat-option.mat-selected:not(.mat-option-disabled) {\n  color: #DB563B;\n}\n\n.calendar-icon {\n  background-image: url('pic-btn-calendar.svg');\n  width: 15px;\n  height: 15px;\n  background-repeat: no-repeat;\n}\n\n.calendar {\n  background: #F7F9FC;\n  border: 1px solid #E0E5EB;\n  color: #2C3640;\n  font-size: 15px;\n  border-radius: 6px;\n  width: 206px;\n  box-sizing: border-box;\n  padding: 11px 13px 9px;\n  height: 39.88px;\n  display: flex;\n  cursor: pointer;\n}\n\n.calendar-value {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  text-align: left;\n  width: 100%;\n}\n\n.departure-schedule mat-form-field.mat-form-field-appearance-outline .mat-select-arrow {\n  background: url('pic-btn-calendar.svg') no-repeat;\n  width: 15px;\n  height: 15px;\n}\n\n.drop-calendar {\n  width: 30rem;\n}\n\n.mat-menu-panel {\n  width: 206px;\n}\n\n.charges {\n  display: flex;\n  margin-top: 40px;\n  padding-top: 40px;\n  border-top: 1px solid #E0E5EB;\n  margin-bottom: 40px;\n  padding-bottom: 40px;\n  border-bottom: 1px solid #E0E5EB;\n}\n\n.included-fees {\n  display: flex;\n  align-items: baseline;\n  justify-content: space-between;\n  width: 100%;\n  margin-bottom: 25px;\n}\n\n.list-charges {\n  display: flex;\n  align-items: baseline;\n  justify-content: space-between;\n  width: 100%;\n  margin-bottom: 25px;\n}\n\n.form-block [type=checkbox]:checked + i + span {\n  font-weight: bold;\n  font-size: 17px;\n}\n\n.form-block [type=checkbox] + i + span {\n  color: #2C3640;\n}\n\n.charges-values .form-data {\n  display: flex;\n  text-wrap: nowrap;\n  align-items: baseline;\n}\n\n.unit {\n  width: 55px;\n  display: block;\n  margin-left: 5px;\n}\n\n.charges-values:last-child .unit {\n  width: 10px;\n}\n\n.total {\n  display: flex;\n  gap: 40px;\n  align-items: center;\n}\n\n.total .total-detail {\n  display: flex;\n  gap: 5px;\n  font-weight: bold;\n  font-size: 22px;\n  line-height: 22px;\n  color: #2C3640;\n}\n\n.total .total-nodetail {\n  display: flex;\n  gap: 5px;\n  font-weight: bold;\n  font-size: 22px;\n  line-height: 22px;\n  color: #2C3640;\n  align-items: baseline;\n}\n\n.total-nodetail .total-cost {\n  background: #F7F9FC;\n  border: 1px solid #E0E5EB;\n  color: #2C3640;\n  border-radius: 6px;\n  padding: 11px 7px 9px;\n  font-weight: bold;\n  font-size: 22px;\n  line-height: 22px;\n  max-width: 70px;\n  text-align: end;\n}\n\n.color-red {\n  color: #DB563B;\n}\n\n.form-block .total [type=checkbox]:checked + i + span {\n  font-weight: normal;\n  font-size: 16px;\n}\n\n.dn {\n  display: none;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  -webkit-appearance: none;\n}\n\ninput[type=number] {\n  -moz-appearance: textfield;\n}\n\n.form-block .charges input[type=number], .form-block select, .form-item-layout input[type=number] {\n  font-family: \"regular\", \"arial\", \"sans-serif\";\n  background: #F7F9FC;\n  border: 1px solid #E0E5EB;\n  color: #2C3640;\n  font-size: 15px;\n  line-height: 15px;\n  border-radius: 6px;\n  width: 100%;\n  box-sizing: border-box;\n  padding: 11px 10px 9px;\n  text-align: end;\n}\n\n.form-block input[type=number][readonly], .form-block select[readonly], .form-block textarea[readonly] {\n  background: transparent;\n  border: 1px dashed #C3CCD6;\n  color: #2C3640;\n}\n\n.charges-values {\n  flex-grow: 0;\n}\n\n.charges-values .values-input {\n  max-width: 75px;\n}\n\n.additional .form-data {\n  width: 75px;\n}\n\n.input-box {\n  display: flex;\n  align-items: baseline;\n}\n\n.cross {\n  background-image: url('pic-btn-cancel-black.svg');\n  background-size: contain;\n  width: 10px;\n  height: 10px;\n  margin: 0 10px;\n}\n\n.equal {\n  color: black;\n  margin-right: 10px;\n}\n\n.br {\n  border-right: 1px solid #E0E5EB;\n  padding-right: 10px;\n  margin-right: 10px;\n}\n\n.transport-point {\n  margin-top: 15px;\n  font-weight: normal;\n}\n\n.copy-map {\n  display: flex;\n  align-items: baseline;\n  margin-top: 15px;\n}\n\n.btn-copy {\n  background-image: url('pic-btn-copy.svg');\n  background-repeat: no-repeat;\n  background-color: white;\n  border: none;\n  color: #DB563B;\n  width: 70px;\n  cursor: pointer;\n  padding: 0;\n  height: 20px;\n}\n\n.btn-map {\n  background-image: url('pic-btn-map.svg');\n  background-repeat: no-repeat;\n  background-color: white;\n  border: none;\n  color: #DB563B;\n  width: 90px;\n  text-decoration: none;\n  display: flex;\n  padding-left: 18px;\n  font-weight: normal;\n  font-size: 14px;\n  display: flex;\n  align-items: center;\n  height: 20px;\n}\n\n.form-block-sub-title {\n  margin-bottom: 40px;\n}\n\n.btn-save-rates {\n  background-color: #DB563B;\n  border: none;\n  border-radius: 6px;\n  padding: 10px;\n  color: white;\n  display: flex;\n  width: 120px;\n  cursor: pointer;\n}\n\n.icon-btn-save-rates {\n  background-image: url('pic-btn-send-white.svg');\n  background-repeat: no-repeat;\n  width: 20px;\n  height: 15px;\n  display: block;\n  margin-right: 5px;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
      encapsulation: 2
    });
  }
}
