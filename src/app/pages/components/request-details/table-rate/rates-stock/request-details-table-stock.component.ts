...
@Component({
  selector: 'app-request-details-table-stock',
  templateUrl: './request-details-table-stock.component.html',
  styleUrls: ['./request-details-table-stock.component.scss'],
...
export class RequestDetailsTableStockComponent extends Table<Contractor, 'trade_rating', ContractorFilter> {
