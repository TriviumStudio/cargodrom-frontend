...
@Component({
  selector: 'app-request-details-table-export',
  templateUrl: './request-details-table-export.component.html',
  styleUrls: ['./request-details-table-export.component.scss'],
...
export class RequestDetailsTableExportComponent extends Table<Contractor, 'trade_rating', ContractorFilter> {
